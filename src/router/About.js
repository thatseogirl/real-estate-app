        ...
        <StyledContainer>
            <AboutContainer>
                <div>
                    <h1>About Us</h1>
                    <div>
                        <p className='text'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore
                            ...
                            unde quod soluta ex inventore quae. Dolor!</p>
                        <StyledAside style={{ marginTop: "2em" }}>
                            <Logo src={estate} alt="Logo" />
                            <div style={{ marginTop: "0.25em" }}>
                                <p>By ThatSeoGirl</p>
                                <a href="https://thatseogirl.netlify.app/" target="_blank" rel='noreferrer'>Personal Portfolio</a>
                            </div>
                        </StyledAside>
                    </div>
                </div>
